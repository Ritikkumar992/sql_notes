        ...
        <Card className={classes.root} variant="outlined">
          <CardContent>
            ...
            <TextField InputLabelProps={{ style: { width: '-webkit-fill-available' } }} className={classes.email} margin='dense'
              onChange={(e) => { handleEmail(e) }} id="outlined-basic1" label="Enter Email" variant="outlined" fullWidth={true} size='small' />
            <TextField InputLabelProps={{ style: { width: '-webkit-fill-available' } }} className={classes.password} margin='dense'
              onChange={(e) => { handlePassword(e) }} id="outlined-basic2" label="Password" variant="outlined" fullWidth={true} size='small' />
